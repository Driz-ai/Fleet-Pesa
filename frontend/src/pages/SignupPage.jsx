    ...
    <div className="min-h-screen w-full bg-slate-100 flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm p-8">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-1.5 rounded-full bg-green-50 px-3 py-1 text-center text-xs font-medium text-slate-400">
